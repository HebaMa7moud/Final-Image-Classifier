...
#python train1.py ImageClassifier/flowers --power gpu --arche 'vgg19' --hidden_layers 4000 --output_layer 102 --learning_rate 0.003 --dropout 0.2 --epochs 10 --save_dir 'checkpoint.pth'
