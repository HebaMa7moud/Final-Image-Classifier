...
#python predict1.py --path_dir 'checkpoint.pth' --cat_nam 'ImageClassifier/cat_to_name.json' --gpu gpu --img_dir 'ImageClassifier/flowers/test/1/image_06743.jpg' --top_k 5
