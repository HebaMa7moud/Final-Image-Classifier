...
def parse_arguments():
    ...
    parser.add_argument('--cat_nam', action ='store', default = 'ImageClassifier/cat_to_name.json')
    parser.add_argument('--img_dir', action='store', default='ImageClassifier/flowers/test/1/image_06743.jpg')
